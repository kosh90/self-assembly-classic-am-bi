...
var epsilon = 0.001;
var show_decor = 1;
var decorations = false; // 0 -- classic decs & 1 -- amman lines
...
function swith_dec(tiles) {
    for (var i = 0; i < tiles.length; i++) {
        tiles[i].decoration_1.visible = !tiles[i].decoration_1.visible;
        tiles[i].decoration_2.visible = !tiles[i].decoration_2.visible;
        tiles[i].amman_1.visible = !tiles[i].amman_1.visible;
        tiles[i].amman_2.visible = !tiles[i].amman_2.visible;
        // tiles[i].decoration_1.strokeColor = 'green';
    }
    decorations = !decorations;


    console.log('switch', decorations);
...
function onKeyDown(event) {
    ...
    if (event.key == 'q') {
        ...
        // b_tiles.push(new place_square_by_edge2(b_tiles[b_tiles.length - 1], 1));
        // b_tiles[b_tiles.length - 1].edge[0].outer = true;
        // b_tiles.push(new place_rhombus_by_edge(b_tiles[b_tiles.length - 1], 1));
        // b_tiles[b_tiles.length - 1].edge[0].outer = true;
        ...
        //
        b_tiles.push(new place_square_by_edge(b_tiles[b_tiles.length - 1], 1));
        b_tiles[b_tiles.length - 1].edge[3].outer = true;
        b_tiles.push(new place_rhombus_by_edge(b_tiles[b_tiles.length - 1], 0));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
        b_tiles[b_tiles.length - 1].edge[3].outer = true;
    ...
    if (event.key == 'w') {
        ...
        b_tiles.push(new place_square_by_edge2(b_tiles[b_tiles.length - 1], 3));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
    ...
    if (event.key == '4') {
        ...
        b_tiles[1].edge[3].outer = true;
        b_tiles[1].edge[0].outer = true;
        b_tiles.push(new place_rhombus_by_edge(b_tiles[b_tiles.length - 1], 2));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
        b_tiles[b_tiles.length - 1].edge[3].outer = true;
        b_tiles.push(new place_rhombus_by_edge(b_tiles[b_tiles.length - 1], 2));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
        ...
        b_tiles.push(new place_square_by_edge(b_tiles[b_tiles.length - 1], 0));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
        b_tiles.push(new place_rhombus_by_edge(b_tiles[b_tiles.length - 1], 3));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
        b_tiles[b_tiles.length - 1].edge[3].outer = true;
        b_tiles.push(new place_rhombus_by_edge(b_tiles[b_tiles.length - 1], 2));
        b_tiles[b_tiles.length - 1].edge[0].outer = true;
...
function Allowed_Diag_Pattens() {
    ...
    var rhombus_long_D = side * Math.sqrt(2 - 2 * Math.cos(3 * 0.78539816339));
    var rhombus_short_D = side * Math.sqrt(2 - 2 * Math.cos(0.78539816339));
...
function Square_Tile(x, y, rot) {
    ...
    this.A = new Point(-side * Math.cos(0.78539816339), 0);
    this.B = new Point(0, side * Math.sin(0.78539816339));
    this.C = new Point(side * Math.cos(0.78539816339), 0);
    this.D = new Point(0, -side * Math.sin(0.78539816339));
    ...
    this.ratio = 0.14645;
    //
    this.amman_1 = new Path.Line(this.vert[0] + this.bc * this.ratio, this.vert[1] + this.bc * this.ratio);
    this.amman_1.strokeColor = 'purple';
    this.amman_1.strokeWidth = '3';
    //
    this.amman_2 = new Path.Line(this.vert[0] + this.ab * this.ratio, this.vert[3] + this.ab * this.ratio);
    this.amman_2.strokeColor = 'purple';
    this.amman_2.strokeWidth = '3';

    if (decorations === false) {
        this.decoration_2.visible = true;
        this.decoration_1.visible = true;
        this.amman_2.visible = false;
        this.amman_1.visible = false;
    } else {
        this.decoration_2.visible = false;
        this.decoration_1.visible = false;
        this.amman_2.visible = true;
        this.amman_1.visible = true;
    }
...
function Rhombus_Tile(x, y, rot) {
    ...
    this.A = new Point(-side * Math.cos(0.39269908169), 0);
    this.B = new Point(0, side * Math.sin(0.39269908169));
    this.C = new Point(side * Math.cos(0.39269908169), 0);
    this.D = new Point(0, -side * Math.sin(0.39269908169));
    ...
    //
    this.ratio = 0.85355;
    this.amman_1 = new Path.Line(this.vert[0] + this.ab * this.ratio, this.vert[2] + this.cd * this.ratio);
    this.amman_1.strokeColor = 'purple';
    this.amman_1.strokeWidth = '3';
    //
    this.amman_2 = new Path.Line(this.vert[2] - this.bc * this.ratio, this.vert[0] - this.da * this.ratio);
    this.amman_2.strokeColor = 'purple';
    this.amman_2.strokeWidth = '3';
    // this.amman_2.visible = true;
...
function pop_tile(tiles) {
    ...
    tiles[tilenum].amman_1.remove();
    tiles[tilenum].amman_2.remove();
